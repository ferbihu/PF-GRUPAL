        ...
        <div>
          ...
          {logeado === "true" ?
            <div className="cont-denuncia">
              ...
              <button className="denuncia-boton" type="submit" disabled={state_popup2 === true || state_popup_warning2 === true} onClick={() => HandleWarningClick()} >Denuncialo</button>
            </div> : <div className="denuncia"><Link to="/iniciasesion">  Iniciá sesión para denunciar el lugar</Link></div>}
        </div>
      </div>
